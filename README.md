...
整数０から3000000までの値の持つ約数を新アルゴリズム（約数の４５度の鏡像予想）を使って調べて＊で表示する。  
...
⚠️ **重要**: このバージョンは教育・研究目的の実装です。整数 3000000 までの約数を扱うため、現代の暗号システム（RSA-4096など）には影響しません。
